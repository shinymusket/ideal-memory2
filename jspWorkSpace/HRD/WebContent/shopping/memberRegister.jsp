...
<%@ include file="../nav/nav.jsp" %>
	<div class="container" align="center">
		<h2>홈쇼핑 회원 등록</h2>
		<form action="SS?command=member_register" method="post" name="frm">
			<table>
				<tr>
					<th>회원번호(자동발생)</th>
					<td>
						<input type="number" name="custno" id="custno" value="${custno}" readonly="readonly"> 
					</td>
				</tr>
				<tr>
					<th>회원성명</th>
				...
				<tr>
					<th>가입일자</th>
					<td>
						<input type="text" name="joindate" id="joindate" value="${date}" readonly="readonly"> 
					</td>
				</tr>
				<tr>
