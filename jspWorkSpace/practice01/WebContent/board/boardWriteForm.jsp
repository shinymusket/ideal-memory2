...
<body>
	<div>
		...
		<div class="w3-margin-top w3-main" style="margin-left: 340px; marign-right: 40px; width: 60%;">
			<form action="/practice01/BoardWrite.do" method="post">
				...
				<div class="w3-margin-bottom w3-border">
					<input type="text" name="board_subject" class="w3-input w3-border w3-white" autofocus="autofocus" placeholder="subject">
				</div>
				<div>
				...
				<div align="center">
					...
					<input type="button" value="취소" class="w3-button w3-white w3-round-smaill" onclick="history.go(-1)">			
				</div>
			</form>
		</div>
	</div>
